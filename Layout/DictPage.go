...
import (
	...
	"github.com/ListenFirstMedia/parquet-go/Compress"
	"github.com/ListenFirstMedia/parquet-go/ParquetEncoding"
...
func (page *Page) DictDataPageCompress(compressType parquet.CompressionCodec, bitWidth int32) []byte {
	...
	valuesRawBuf = append(valuesRawBuf, ParquetEncoding.WriteRLE(page.DataTable.Values, bitWidth, parquet.Type_INT32)...)
